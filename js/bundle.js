...
function cards() {
  ...
  (0,_services_services_js__WEBPACK_IMPORTED_MODULE_0__.getResourses)('http://localhost:3000/menu').then(data => {
    data.forEach(_ref => {
      let {
        img,
        altimg,
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022.07.30');
